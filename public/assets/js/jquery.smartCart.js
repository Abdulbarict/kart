...
// PRIVATE FUNCTIONS
        ...
        _setToolbar: function () {
            ...
            if(this.options.toolbarSettings.showCartSummary){
               ...
               // console.log(this.options.lang.delivery_charge);
               // alert(JSON.stringify(this.options.lang.delivery_charge));
               if(this.options.lang.delivery_charge.active)
               {
                panelSubTotal.append('<div class="sc-cart-summary-deliveryCharge d-none">'+this.options.lang.delivery_charge.text+': <span class="sc-cart-deliveryCharge">'+this._getMoneyFormatted(this.options.lang.delivery_charge.amount)+'</span></div>');
               }
        ...
        _hasCartChange: function () {
            ...
            if(this.cart.length === 0){
                ...
                $('.sc-cart-summary-deliveryCharge').addClass('d-none');
                ...
                $('.sc-cart-summary-deliveryCharge').removeClass('d-none');
            }
        ...
        _getCartSubtotal: function () {
            ...
            if($.inArray(delivery, this.options.lang.delivery_charge.option) !== -1){
               
                if(this.options.lang.delivery_charge.active){
                   
                    if(this.cart.length > 0){
                       
                        if(this.options.lang.delivery_charge.extra_charge_upto > subtotal || this.options.lang.delivery_charge.extra_charge_upto == -1){
                            subtotal += parseFloat(this.options.lang.delivery_charge.amount);
                          //  alert(this.options.lang.delivery_charge.extra_charge_upto);
                            $('.sc-cart-summary-deliveryCharge').show();
                            $('#deliveryCharge').val(this.options.lang.delivery_charge.amount);
                        }
                        else{
                            $('.sc-cart-summary-deliveryCharge').hide();
                            $('#deliveryCharge').val('');
                        }
                    }
                }
